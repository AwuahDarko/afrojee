...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        Route::get('/products/deactivate/{id}', [ProductController::class, 'deactivate'])->name('admin.products.deactivate');
        ...
        Route::get('/products/feature/{id}', [ProductController::class, 'feature'])->name('admin.products.feature');
        ...
        Route::patch('reviews/{review}/approve', [ReviewsController::class, 'approve'])->name('admin.reviews.approve');
        Route::patch('reviews/{review}/reject', [ReviewsController::class, 'reject'])->name('admin.reviews.reject');
        Route::patch('reviews/{review}/toggle-featured', [ReviewsController::class, 'toggleFeatured'])->name('admin.reviews.toggle-featured');

        Route::post('reviews/bulk-action', [ReviewsController::class, 'bulkAction'])->name('admin.reviews.bulk-action');
