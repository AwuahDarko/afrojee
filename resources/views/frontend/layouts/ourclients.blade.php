...
<section class="bg-pink-50">
    <div class="container mx-auto px-4 py-12">
        ...
        <!-- <div class="mb-8">
            <h2 class="text-5xl font-medium text-rose-700">What Our</h2>
            <h2 class="text-5xl font-bold text-rose-700">Clients Say</h2>
            <div class="mt-4 border-t border-rose-300 w-full "></div>
        </div> -->
