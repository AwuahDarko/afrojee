<section class="relative bg-cover bg-center bg-no-repeat py-25 px-6 tye"
    style="background-image: url('/images/p3.png');">
    <div class="absolute inset-0 bg-taupe opacity-50"></div>
    ...
    <div class="relative z-10 container max-w-1xl mx-auto text-left text-white">
        ...
        <!-- <div class="mb-12">
            <div class="flex items-center mb-2">
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-light w-1/5 mb-2">
                Subscribe To <br><span class="font-bold">Our Newsletter? </span>
                </h2>
                <div class="bg-white h-1 backdrop-blur-sm  w-5/6 min-w-lg mt-4 mb-8"></div>
            </div>
        </div> -->
