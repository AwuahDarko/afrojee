    ...
    <section class="bg-[#f7f3e9] py-16 px-6">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="flex flex-wrap justify-start gap-4 mb-10">
                ...
                @foreach ($categories as $category)
                    <a href="{{ route('web.products.filterByCategory', ['slug' => $category->slug]) }}" data-filter="{{ strtolower(str_replace(' ', '-', $category->name)) }}"
                ...
                @foreach ($products as $product)
                    <div class="product-card text-left"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <button
                                class="bg-white border border-pink-800 p-2 rounded-full text-pink-800 hover:bg-pink-100 transition-colors duration-200">
        ...
        <div class="flex justify-center items-center space-x-2 mt-8">
            ...
            <a href="{{ $products->previousPageUrl() }}"
                class="pagination-button text-pink-800 font-bold px-1 py-1 rounded-full border border-transparent hover:border-pink-800 transition duration-300 flex items-center space-x-1 {{ $products->onFirstPage() ? 'pointer-events-none opacity-50' : '' }}">
            ...
            <a href="{{ $products->nextPageUrl() }}"
                class="pagination-button text-pink-800 font-bold px-3 py-1 rounded-full border border-transparent hover:border-pink-800 transition duration-300 flex items-center space-x-1 {{ $products->currentPage() == $products->lastPage() ? 'pointer-events-none opacity-50' : '' }}">
