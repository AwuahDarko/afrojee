            ...
            <div class="md:col-span-1 bg-white rounded-xl p-6 shadow-sm h-fit sticky top-8">
                ...
                <div id="checkout-summary">
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <p class="font-bold text-gray-900" id="total-lbl"> {{ number_format(0, 2) }}</p>
                    </div>
                    <div class="flex justify-between items-center mb-6">
                        <p class="text-gray-700">Delivery</p>
                        @if ($userAddress)
                            <p class="font-bold text-gray-900" id="del-lbl"> {{ number_format(0, 2) }}</p>
                        @else
                    ...
                    <div class="flex justify-between items-center border-t border-gray-300 pt-4 mb-6">
                        ...
                        <p class="text-3xl font-bold text-gray-900" id="grand-lbl"> {{ number_format(0, 2) }}
                        </p>
                    </div>
                </div>
                <button
