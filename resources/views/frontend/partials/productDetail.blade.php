<section class="bg-[#f7f3e9] px-6 py-12 text-gray-800">
    <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-start">
        ...
        <!-- Product Details -->
        <div>
            <h1 class="text-2xl font-semibold mb-2">Always moisturized Body Butter</h1>
    ...
    <div id="description-content" class="tab-content max-w-4xl mx-auto mt-12">
        ...
        <p class="text-gray-700 leading-relaxed mb-6">
            ...
            butter, coconut oil, and natural botanicals. This cream deeply moisturizes and strengthens hair, leaving it
            soft, shiny, and manageable. Perfect for all hair types, especially dry or damaged hair, it provides lasting
            hydration without weighing your hair down. Use it daily to define curls, smooth frizz, or as a deep
            conditioning treatment for a healthy, vibrant look.
        </p>
