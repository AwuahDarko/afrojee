                ...
                @forelse($featured_products as $product)
                    <div class="group relative product-card bg-white rounded-2xl shadow-lg overflow-hidden"
                        ...
                        <div class="hover-accent absolute -top-4 -left-4 z-10">
                            <svg width="120" height="60" viewBox="0 0 231 94" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.6">
                                    <path d="M9.89791 12.1723C32.8258 10.1112 99.2605 12.0607 181.576 36.3473"
                                        stroke="#F3BF45" stroke-width="8" stroke-linecap="round" />
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-2">
                                <h3
                                    class="text-xl font-bold text-gray-800 group-hover:text-burgundy transition-colors flex-1">
                                    {{ $product->name }}
                                </h3>
                                @if($product->category)
                                ...
                                <div class="flex gap-2">
                                    @if($product->quantity > 0)
                                        <button id="add-to-cart-button"
                                            ...
                                            <svg class="w-5 h-5 cart-icon" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
