...
<section class="py-16 px-4 md:px-8">
        ...
        <div class="md:w-1/2 p-4">
            ...
            <div class="flex items-center mb-4">
                <div class="flex text-yellow-400">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                        <path
                            d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.828 1.48 8.286L12 18.896l-7.416 3.924 1.48-8.286-6.064-5.828 8.332-1.151z" />
                    </svg>
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                        <path
                            d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.828 1.48 8.286L12 18.896l-7.416 3.924 1.48-8.286-6.064-5.828 8.332-1.151z" />
            ...
            <div class="flex items-center mb-6">
                ...
                <div class="flex items-center border border-gray-300 rounded-md">
                    <button id="decrement"
                        class="px-3 py-1 text-xl font-bold text-gray-600 hover:bg-gray-100 rounded-l-md">-</button>
                    <input type="text" id="quantity" value="1"
                        class="w-12 text-center border-l border-r border-gray-300 focus:outline-none" readonly>
                    <button id="increment"
                        class="px-3 py-1 text-xl font-bold text-gray-600 hover:bg-gray-100 rounded-r-md">+</button>
                </div>
            </div>

            <div class="flex space-x-4">
                <button
                    class="btn-primary flex items-center justify-center px-6 py-3 rounded-lg text-lg font-semibold hover:opacity-90 transition duration-300 ease-in-out">
                    Buy Now
                ...
                <button
                    class="flex items-center justify-center px-4 py-3 rounded-lg border border-gray-300 text-gray-600 hover:bg-gray-50 transition duration-300 ease-in-out">
    ...
    <div class="mt-8 px-6 pb-6">
        <div class="flex space-x-4 border-b border-gray-200 mb-6">
            <button class="tab-button px-6 py-3 rounded-t-lg font-semibold text-gray-700 hover:bg-gray-100 active"
                data-tab="description">Description</button>
            <button class="tab-button px-6 py-3 rounded-t-lg font-semibold text-gray-700 hover:bg-gray-100"
                data-tab="ingredients">Ingredients</button>
            <button class="tab-button px-6 py-3 rounded-t-lg font-semibold text-gray-700 hover:bg-gray-100"
                data-tab="how-to-use">How To Use</button>
            <button class="tab-button px-6 py-3 rounded-t-lg font-semibold text-gray-700 hover:bg-gray-100"
        ...
        <div id="description-content" class="tab-content">
            ...
            <p class="text-gray-700 leading-relaxed">
                Transform your hair care routine with our Nourishing Shea Butter Hair Cream, a luxurious blend of rich
                shea butter, coconut oil, and natural botanicals. This cream deeply moisturizes and strengthens hair,
                leaving it soft, shiny, and manageable. Perfect for all hair types, especially dry or damaged hair, it
                provides lasting hydration without weighing your hair down. Use it daily to define curls, smooth frizz,
                or as a deep conditioning treatment for a healthy, vibrant look.
            </p>
        </div>
        ...
        <div id="how-to-use-content" class="tab-content hidden">
            ...
            <p class="text-gray-700 leading-relaxed">
                Apply a small amount to damp or dry hair, focusing on mid-lengths and ends. Style as desired. For deep
                conditioning, apply a generous amount to clean, damp hair, leave on for 15-20 minutes, then rinse
                thoroughly.
            </p>
        </div>
